...
const Projects = () => {
  ...
  const [cards, setCard] = useState([
    {
      numberProject: "Exchange Rates",
      aboutProject:
        "This project is a SPA. " +
        "In this project I use React, Redux, SCSS, Axios, apiExchangeRates",
      id: 1,
      active: false,
      href: "https://errornone.github.io/kozhindev-test-exchanges/",
    },
    {
      numberProject: "Concert club",
      aboutProject:
        "This project is a multipage React application. " +
      ...
      <div className="container container__projects">
        ...
        <div className="projects__cards">
          {cards.map((card) => {
            return (
              <div
                className={`card${card.active && mobile ? " active" : ""}${
                  !mobile ? " desktop" : ""
                }`}
                id={card.id}
                key={card.id}
              >
                ...
                <div className="card__body">
                  ...
                  <a target="_blank" href={card.href} rel="noreferrer">
                    Look project
                  </a>
                </div>
              </div>
